...
import moony.compactcrafting.SlotPressureMachine;
...
public class ContainerPressureMachine extends Container
{
	private TilePressureMachine furnace;
	private int lastCookTime = 0;
	private int lastBurnTime = 0;
	private int lastItemBurnTime = 0;

	public ContainerPressureMachine(InventoryPlayer par1InventoryPlayer,
			TilePressureMachine tileEntity)
	{
		this.furnace = tileEntity;
		this.addSlotToContainer(new Slot(tileEntity, 0, 56, 17));
		this.addSlotToContainer(new Slot(tileEntity, 1, 56, 53));
		this.addSlotToContainer(new SlotPressureMachine(
				par1InventoryPlayer.player, tileEntity, 2, 116, 35));
		int i;
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			{
				if (PressureMachineRecipes.smelting().getSmeltingResult(
						itemstack1) != null)
				{
				...
				} else if (TilePressureMachine.isItemFuel(itemstack1))
				{
