...
import moony.compactcrafting.BlockPressureMachine;
...
public class TilePressureMachine extends TileEntity implements IInventory,
		ISidedInventory
{
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack itemstack = PressureMachineRecipes.smelting()
